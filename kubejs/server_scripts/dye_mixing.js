ServerEvents.recipes((event) => {
  ...
  event.recipes.create.mixing(
    ...
    [
      Fluid.of("kubejs:black_dye_fluid", 250),
      Fluid.of("kubejs:white_dye_fluid", 750),
    ]
  );
  event.recipes.create.mixing(
    [Fluid.of("kubejs:light_gray_dye_fluid", 1000)],
    [
      Fluid.of("kubejs:gray_dye_fluid", 500),
  ...
  event.recipes.create.mixing(
    ...
    [
      Fluid.of("kubejs:red_dye_fluid", 500),
  ...
  event.recipes.create.mixing(
    ...
    [
      Fluid.of("kubejs:green_dye_fluid", 500),
      Fluid.of("kubejs:blue_dye_fluid", 500),
    ]
  );
  event.recipes.create.mixing(
  ...
  event.recipes.create.mixing(
    [Fluid.of("kubejs:pink_dye_fluid", 1000)],
    [
      Fluid.of("kubejs:purple_dye_fluid", 750),
      Fluid.of("kubejs:white_dye_fluid", 250),
    ]
  );
  event.recipes.create.mixing(
    [Fluid.of("kubejs:magenta_dye_fluid", 1000)],
    [
      Fluid.of("kubejs:pink_dye_fluid", 500),
      Fluid.of("kubejs:purple_dye_fluid", 500),
    ]
  );
});
